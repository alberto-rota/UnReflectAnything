...
class PoseCNN_AFSfMLearner(nn.Module):
    def __init__(self, num_input_frames=2):
        super(PoseCNN_AFSfMLearner, self).__init__()
...
class DepthCNN_AFSfMLearner(nn.Module):
    def __init__(self, num_input_frames=1):
        super(DepthCNN_AFSfMLearner, self).__init__()

        self.encoder = ResnetEncoder(50, True, num_input_frames)
